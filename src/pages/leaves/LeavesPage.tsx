    ...
    >
      <div className="form-row">
        <Field label="From" required>
          <Input type="date" value={form.start_date} min={today} max={form.end_date || undefined} onChange={(e) => setForm({ ...form, start_date: e.target.value })} />
        </Field>
        <Field label="To" required>
          <Input type="date" value={form.end_date} min={form.start_date || today} onChange={(e) => setForm({ ...form, end_date: e.target.value })} />
        </Field>
      </div>
